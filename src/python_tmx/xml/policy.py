...
def _default_policy(behavior: Behavior = "raise", level: int = logging.ERROR) -> PolicyValue[Behavior]:
...
class DeserializationPolicy:
  ...
  missing_text: PolicyValue[Literal["raise", "empty", "ignore"]] = _default_policy()
