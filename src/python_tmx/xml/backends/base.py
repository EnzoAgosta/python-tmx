...
class XMLBackend[T_XmlBackend](Protocol):
  ...
  def iter_children(self, element: T_XmlBackend, tag: str | Collection[str] | None = None) -> Iterator[T_XmlBackend]: ...
  def find(self, element: T_XmlBackend, tag: str) -> T_XmlBackend | None: ...
