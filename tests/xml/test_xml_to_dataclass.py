...
class TestElementToDataclass:
  def test_note_element_to_dataclass(self, element_provider):
    note_element = element_provider.note_element()
  ...
  def test_prop_element_to_dataclass(self, element_provider):
    prop_element = element_provider.prop_element()
  ...
  def test_header_element_to_dataclass(self, element_provider):
    header_element = element_provider.header_element()
  ...
  def test_tuv_element_to_dataclass(self, element_provider):
    tuv_element = element_provider.tuv_element()
  ...
  def test_tu_to_element(self, element_provider):
    tu_element = element_provider.tu_element()
  ...
  def test_tmx_to_element(self, element_provider):
    tmx_element = element_provider.tmx_element()
  ...
  def test_bpt_to_element(self, element_provider):
    bpt_element = element_provider.bpt_element()
  ...
  def test_ept_to_element(self, element_provider):
    ept_element = element_provider.ept_element()
  ...
  def test_it_to_element(self, element_provider):
    it_element = element_provider.it_element()
  ...
  def test_sub_to_element(self, element_provider):
    sub_element = element_provider.sub_element()
  ...
  def test_ph_to_element(self, element_provider):
    ph_element = element_provider.ph_element()
  ...
  def test_hi_to_element(self, element_provider):
    hi_element = element_provider.hi_element()
  ...
  def test_element_to_dataclass(self, element_provider):
    elements = {
      element_provider.bpt_element: Bpt, 
      element_provider.ept_element: Ept, 
      element_provider.it_element: It, 
      element_provider.sub_element: Sub, 
      element_provider.ph_element: Ph, 
      element_provider.hi_element: Hi, 
      element_provider.note_element: Note, 
      element_provider.prop_element: Prop, 
      element_provider.tuv_element: Tuv, 
      element_provider.tu_element: Tu, 
      element_provider.header_element: Header, 
      element_provider.tmx_element: Tmx, 
    }
