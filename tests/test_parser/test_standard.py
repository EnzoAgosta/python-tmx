...
from PythonTmx.parsers.standard import StandardParser


def test_standard_parser_initialization(sample_tmx_file):
  """Test StandardParser initialization with valid file."""
  parser = StandardParser(sample_tmx_file)
  assert parser.source == sample_tmx_file


def test_standard_parser_initialization_nonexistent_file(nonexistent_file):
  """Test StandardParser initialization with nonexistent file."""
  with pytest.raises(FileNotFoundError):
    StandardParser(nonexistent_file)


def test_standard_parser_initialization_empty_file(empty_file):
  """Test StandardParser initialization with empty file."""
  with pytest.raises(ValueError):
    StandardParser(empty_file)


def test_standard_parser_iter_all_elements(sample_tmx_file):
...
def test_standard_parser_iter_with_single_mask(sample_tmx_file):
...
def test_standard_parser_iter_with_multiple_mask(sample_tmx_file):
...
def test_standard_parser_iter_with_exclude(sample_tmx_file):
...
def test_standard_parser_iter_breadth_first_strategy(sample_tmx_file):
...
def test_standard_parser_iter_depth_first_strategy(sample_tmx_file):
...
def test_standard_parser_iter_invalid_strategy(sample_tmx_file):
...
def test_standard_parser_iter_unknown_tag_mask(sample_tmx_file):
...
def test_standard_parser_lazy_iter_all_elements(sample_tmx_file):
...
def test_standard_parser_lazy_iter_with_mask(sample_tmx_file):
...
def test_standard_parser_lazy_iter_with_exclude(sample_tmx_file):
...
def test_standard_parser_invalid_xml(invalid_xml_file):
  """Test parser with invalid XML file."""
  with pytest.raises(ValueError):
    StandardParser(invalid_xml_file)


def test_standard_parser_unknown_tag_error(unknown_tag_file):
  """Test parser with unknown tag in XML."""
  parser = StandardParser(unknown_tag_file)
...
def test_standard_parser_complex_file_with_inline_elements(complex_tmx_file):
  """Test parser with complex TMX file containing inline elements."""
  parser = StandardParser(complex_tmx_file)
...
def test_standard_parser_breadth_vs_depth_order(sample_tmx_file):
...
def test_standard_parser_memory_efficiency_lazy_iter(sample_tmx_file):
...
def test_standard_parser_line_number_not_in_error(unknown_tag_file):
...
def test_standard_parser_empty_mask_results(sample_tmx_file):
...
def test_standard_parser_exclude_all_elements(sample_tmx_file):
...
def test_standard_parser_string_path(sample_tmx_file):
  """Test parser initialization with string path."""

  StandardParser(sample_tmx_file.as_posix())


def test_standard_parser_pathlike_object(sample_tmx_file):
  """Test parser initialization with PathLike object."""
  from pathlib import Path

  path_obj = Path(sample_tmx_file)
  parser = StandardParser(path_obj)
  elements = list(parser.iter())
  assert len(elements) > 0


def test_standard_parser_large_file_handling(massive_tmx_file):
  """Test parser with a larger file to ensure it handles memory properly."""
  parser = StandardParser(massive_tmx_file)
  tracemalloc.start()
...
def test_standard_parser_default_factory_setting(sample_tmx_file):
...
def test_standard_parser_empty_file_handling():
  ...
  try:
    parser = StandardParser(temp_file)
...
def test_standard_parser_malformed_xml_handling():
...
def test_standard_parser_namespace_handling(namespaced_tmx_file):
  """Test parser with XML that has namespaces."""
  parser = StandardParser(namespaced_tmx_file)
  elements = list(parser.iter())
  assert len(elements) > 0


def test_standard_parser_edge_case_empty_body():
